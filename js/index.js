        ...
        subtext: "Computer Science undergraduate (senior year) based in Kolkata, India",
        jobStatus: "Looking for an internship (preferably, research-oriented) in Deep Learning (specifically, Computer Vision and NLP).",
              ...
              <div className="right-inner">
                <div className="introduction">
                  ...
                  <div className="content">
                    <p className="intro-p">I&#39;m currently in my fourth (and final) year, studying Computer Science & Engineering at Institute of Engineering & Management(IEM), Kolkata. I will be graduating in June 2021 (expected).</p>
